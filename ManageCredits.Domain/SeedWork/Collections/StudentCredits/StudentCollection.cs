...
class StudentCollection : ISeedDataCollection<Guid, StudentEntity>
{
  ...
  readonly StudentEntity[] _students = new StudentEntity[2];

  public int Length => _students.Length;

  public Guid this[int index] => _students.ElementAt(index).StudentId;
  ...
  public IEnumerable<StudentEntity> GetAll() => [.. _students];

  private void Init(params StudentEntity[] students)
  {
