...
class SubjectCollection : SeedDataCollection<SubjectEntity>
{
  protected override SubjectEntity[] Collection => [
    ...
    new SubjectEntity
    {
      ...
      Created = new DateTimeOffset(2024, 1, 16, 0, 0, 0, TimeSpan.Zero)
    },
    new SubjectEntity
    {
      ...
      Created = new DateTimeOffset(2024, 1, 17, 0, 0, 0, TimeSpan.Zero)
    },
    new SubjectEntity
    {
      ...
      Created = new DateTimeOffset(2024, 1, 18, 0, 0, 0, TimeSpan.Zero)
    },
    new SubjectEntity
    {
      ...
      Created = new DateTimeOffset(2024, 1, 19, 0, 0, 0, TimeSpan.Zero)
    },
    new SubjectEntity
    {
      ...
      Created = new DateTimeOffset(2024, 1, 20, 0, 0, 0, TimeSpan.Zero)
    },
    new SubjectEntity
    {
      ...
      Created = new DateTimeOffset(2024, 1, 21, 0, 0, 0, TimeSpan.Zero)
    },
    new SubjectEntity
    {
      ...
      Created = new DateTimeOffset(2024, 1, 22, 0, 0, 0, TimeSpan.Zero)
    },
    new SubjectEntity
    {
      ...
      Created = new DateTimeOffset(2024, 1, 23, 0, 0, 0, TimeSpan.Zero)
    }
  ];

  public SubjectCollection() : base(10) { }
}
