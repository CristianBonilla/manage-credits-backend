...
class SubjectCollection : ISeedDataCollection<SubjectEntity, SubjectEntity>
{
  readonly SubjectEntity[] _subjects = new SubjectEntity[2];

  public int Length => _subjects.Length;

  public SubjectEntity this[int index] => _subjects.ElementAt(index);
  ...
  public IEnumerable<SubjectEntity> GetAll() => [.. _subjects];

  private void Init(params SubjectEntity[] subjects)
  {
