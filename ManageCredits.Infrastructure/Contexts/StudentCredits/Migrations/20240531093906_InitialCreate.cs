  ...
  public partial class InitialCreate : Migration
  {
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            StudentId = table.Column<Guid>(type: "char(36)", nullable: false, defaultValueSql: "UUID()"),
            DocumentNumber = table.Column<string>(type: "varchar(255)", nullable: false),
            Firstname = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
            Lastname = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
            Email = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: false),
            Created = table.Column<DateTimeOffset>(type: "datetime", nullable: false, defaultValueSql: "UTC_TIMESTAMP()"),
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            SubjectId = table.Column<Guid>(type: "char(36)", nullable: false, defaultValueSql: "UUID()"),
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            TeacherId = table.Column<Guid>(type: "char(36)", nullable: false, defaultValueSql: "UUID()"),
            DocumentNumber = table.Column<string>(type: "varchar(255)", nullable: false),
            Firstname = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
            Lastname = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
            Email = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: false),
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            ClassId = table.Column<Guid>(type: "char(36)", nullable: false, defaultValueSql: "UUID()"),
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            TeacherDetailId = table.Column<Guid>(type: "char(36)", nullable: false, defaultValueSql: "UUID()"),
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            StudentDetailId = table.Column<Guid>(type: "char(36)", nullable: false, defaultValueSql: "UUID()"),
            TeacherDetailId = table.Column<Guid>(type: "char(36)", nullable: false),
      ...
      migrationBuilder.InsertData(
          ...
          values: new object[,]
          {
                    { new Guid("11ab0e13-3a0a-4fd7-9f80-3dc89b181efb"), new Guid("b96044ee-9bb6-4733-af11-1bd8eedf8b7d"), new DateTimeOffset(new DateTime(2024, 3, 2, 1, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "Completed", new Guid("00000000-0000-0000-0000-000000000000"), new Guid("f87b9e01-7066-4a18-bbe5-560a9c6ddec2") },
                    { new Guid("2096ecba-29db-49d6-9646-a6c3e424953f"), new Guid("96437dd9-f3c7-4b11-a2a5-c59a0d5aed1c"), new DateTimeOffset(new DateTime(2024, 3, 3, 2, 1, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "Completed", new Guid("00000000-0000-0000-0000-000000000000"), new Guid("f87b9e01-7066-4a18-bbe5-560a9c6ddec2") },
                    { new Guid("58696965-ccef-46b8-b791-74c4f8c28f25"), new Guid("a9a5f58a-2b02-4a0e-bf43-88a1080c82b4"), new DateTimeOffset(new DateTime(2024, 3, 6, 5, 4, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "Pending", new Guid("00000000-0000-0000-0000-000000000000"), new Guid("f79f1e3c-8974-4b38-8f9d-72e738efb046") },
                    { new Guid("6647c961-57b7-4e04-ad8f-3213a6b85f89"), new Guid("4905befb-9d92-42dd-8be3-82d761339b34"), new DateTimeOffset(new DateTime(2024, 3, 3, 2, 1, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "Completed", new Guid("00000000-0000-0000-0000-000000000000"), new Guid("f79f1e3c-8974-4b38-8f9d-72e738efb046") },
                    { new Guid("7f8a160f-b415-486d-bce2-af44c58af36c"), new Guid("c5bc16d1-1046-4b44-976a-564fc5df7d65"), new DateTimeOffset(new DateTime(2024, 3, 4, 3, 2, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "InProgress", new Guid("00000000-0000-0000-0000-000000000000"), new Guid("f79f1e3c-8974-4b38-8f9d-72e738efb046") },
                    { new Guid("90812e38-67ad-4207-8017-e2b09231231e"), new Guid("85f0c48a-7b2b-456a-95fb-8c6b827a719c"), new DateTimeOffset(new DateTime(2024, 3, 2, 1, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "InProgress", new Guid("00000000-0000-0000-0000-000000000000"), new Guid("f79f1e3c-8974-4b38-8f9d-72e738efb046") },
                    { new Guid("eab71419-9084-4e72-9558-ce4d76f0fd30"), new Guid("fe4f5476-b903-4399-b4d8-d97d9d3b1c22"), new DateTimeOffset(new DateTime(2024, 3, 4, 3, 2, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "Completed", new Guid("00000000-0000-0000-0000-000000000000"), new Guid("f87b9e01-7066-4a18-bbe5-560a9c6ddec2") },
                    { new Guid("fa2a8cc5-c7ae-4577-a981-3d4ab4a2ef1b"), new Guid("39537c6a-49d9-4496-a170-6e95d517ca81"), new DateTimeOffset(new DateTime(2024, 3, 5, 4, 3, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "InProgress", new Guid("00000000-0000-0000-0000-000000000000"), new Guid("f79f1e3c-8974-4b38-8f9d-72e738efb046") }
          });
